"""Event-specific reducer handlers for K.I.T.T. TUI state."""
...
def handle_thinking_started(state: UIState, event: ThinkingStarted) -> None:
...
def handle_thinking_completed(state: UIState, event: ThinkingCompleted) -> None:
...
def handle_text_delta(state: UIState, event: TextDelta) -> None:
...
def handle_tool_completed(state: UIState, event: ToolCompleted) -> None:
...
def handle_context_events(state: UIState, event: object) -> None:
...
def handle_child_agent_events(state: UIState, event: object) -> None:
    if isinstance(event, ChildAgentSpawned):
...
def handle_terminal_events(state: UIState, event: object) -> None:
