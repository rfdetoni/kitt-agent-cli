...
class CommandRegistry:
    ...
    def _register_defaults(self):
        rows = [
            ...
            ("reverse_proxy", "KITT Reverse Proxy", "System", "Manage reverse-proxy instances, profiles, plugins and role bindings", ["/reverse-proxy", "/proxy"]),
            ...
            ("mouse", "Toggle Mouse Mode", "System", "Toggle between TUI mouse and terminal native selection (F10)", ["/mouse"]),
            ("sidebar", "Toggle Sidebar", "Navigation", "Show or hide workspace/context sidebar", ["/sidebar"]),
