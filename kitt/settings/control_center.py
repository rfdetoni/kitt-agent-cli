...
class SettingsDescriptorProvider:
    ...
    def get_sections(cls) -> list[dict[str, Any]]:
        ...
        context_fields = [
            ...
            {"key": "compaction_trigger_ratio", "label": "Compaction trigger ratio", "type": "number", "default": default_config.compaction_trigger_ratio, "minimum": 0.5, "maximum": 0.95, "apply_mode": "component_restart"},
            ...
            {"key": "tool_receipt_min_tokens", "label": "Tool receipt min tokens", "type": "integer", "default": default_config.tool_receipt_min_tokens, "minimum": 32, "maximum": 32768, "apply_mode": "component_restart"},
            {"key": "tool_receipt_excerpt_chars", "label": "Tool receipt excerpt chars", "type": "integer", "default": default_config.tool_receipt_excerpt_chars, "minimum": 80, "maximum": 4096, "apply_mode": "component_restart"},
